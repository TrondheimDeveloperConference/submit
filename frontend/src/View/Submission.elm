...
viewSubmissionDetails submission model =
    div []
        ...
        , div [ class <| "edit-intro " ++ hideIfNotEditable submission.editable ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "April 1th" ], text "Create your talk" ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "June 1th" ], text "Submission deadline" ]
                , p [] [ text "Get all your last touches in by June 1th. After that, the program committee will go through all talks and select what will be a part of the program." ]
                ]
            , div [ class "help-part" ]
