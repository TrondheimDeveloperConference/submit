...
viewSubmissionDetails submission model =
    div []
        ...
        , div [ class <| "edit-intro " ++ hideIfNotEditable submission.editable ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "April 8th - June 8th" ], text "Finish you submission" ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "June 8th" ], text "Submission deadline" ]
                , p [] [ text "Get all your last touches in by June 8th. After that, the program committee will go through all talks and select what will be a part of the program." ]
                ]
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "August 8th" ], text "Know your result" ]
